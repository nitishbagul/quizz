...
function displayWrongFeedback() {
    $('.main-content').html(`<section class="feedback-page" role="main">
         <h3>Sorry, that was a wrong answer! Correct ansewer is: <br> <br> <span class="answer-text">${questions[QUESTION_TRACKER].answer_options[questions[QUESTION_TRACKER].answer_key]}</span></h3>
         <button type="submit" class="next-question">Next</button>
        </section>`);
}
